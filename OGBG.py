...
def main(config=None):
    ...
    for seed in seeds_to_test:
        ...
        if args.configuration == 'c1':
            model = SE2P_C1(enriched_dataset.num_features, 1 if args.dataset == 'ogbg-molhiv' else 12, args).to(device)

        elif args.configuration == 'c2':
            model = SE2P_C2(enriched_dataset.num_features, 1 if args.dataset == 'ogbg-molhiv' else 12, args).to(device)
